 ...
 */
trait ParSeq[T] extends scala.collection/*.mutable*/.GenSeq[Any, T] // was: scala.collection.mutable.Seq[Any, T]
                   with ParIterable[T]
                   with scala.collection.parallel.ParSeq[T]
                   with GenericParTemplate[T, ParSeq]
                   with ParSeqLike[T, ParSeq[T], scala.collection.mutable.Seq[Any, T]] {
self =>
  ...
  def seq: scala.collection.mutable.Seq[Any, T]
