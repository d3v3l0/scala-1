 ...
 */
trait TraversableFactory[L, CC[X] <: Traversable[L, X] with GenericTraversableTemplate[L, X, CC]]
  extends GenTraversableFactory[L, CC] with GenericSeqCompanion[L, CC]
