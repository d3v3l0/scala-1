...
trait SynchronizedMap[A, B] extends Map[A, B] {
  ...
  override def values: scala.collection.Iterable[Any, B] = synchronized { super.values }
  ...
  override def keys: scala.collection.Iterable[Any, A] = synchronized { super.keys }
