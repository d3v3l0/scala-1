...
trait ArrayOps[L, T] extends Any with ArrayLike[L, T, Array[T]] with CustomParallelizable[L, T, ParArray[L, T]] {
   ...
   */
  def flatten[U](implicit asTrav: T => scala.collection.Traversable[L, U], m: ClassTag[U]): Array[U] = {
    val b = Array.newBuilder[U]
    b.sizeHint(map{case is: scala.collection.IndexedSeq[L, _] => is.size case _ => 0}.sum)
    for (xs <- this)
      b ++= asTrav(xs)
    b.result()
  }
  ...
  def transpose[U](implicit asArray: T => Array[U]): Array[Array[U]] = {
    val bb: Builder[L, Array[U], Array[Array[U]]] = Array.newBuilder(ClassTag[Array[U]](elementClass))
...
object ArrayOps {
  ...
  final class ofRef[T <: AnyRef](override val repr: Array[T]) extends AnyVal with ArrayOps[L, T] with ArrayLike[L, T, Array[T]] {

    override protected[this] def thisCollection: WrappedArray[L, T] = new WrappedArray.ofRef[T](repr)
    override protected[this] def toCollection(repr: Array[T]): WrappedArray[L, T] = new WrappedArray.ofRef[T](repr)
...
final class ofByte(override val repr: Array[Byte]) extends AnyVal with ArrayOps[L, Byte] with ArrayLike[L, Byte, Array[Byte]] {

    override protected[this] def thisCollection: WrappedArray[L, Byte] = new WrappedArray.ofByte(repr)
    override protected[this] def toCollection(repr: Array[Byte]): WrappedArray[L, Byte] = new WrappedArray.ofByte(repr)
...
final class ofShort(override val repr: Array[Short]) extends AnyVal with ArrayOps[L, Short] with ArrayLike[L, Short, Array[Short]] {

    override protected[this] def thisCollection: WrappedArray[L, Short] = new WrappedArray.ofShort(repr)
    override protected[this] def toCollection(repr: Array[Short]): WrappedArray[L, Short] = new WrappedArray.ofShort(repr)
...
final class ofChar(override val repr: Array[Char]) extends AnyVal with ArrayOps[L, Char] with ArrayLike[L, Char, Array[Char]] {

    override protected[this] def thisCollection: WrappedArray[L, Char] = new WrappedArray.ofChar(repr)
    override protected[this] def toCollection(repr: Array[Char]): WrappedArray[L, Char] = new WrappedArray.ofChar(repr)
...
final class ofInt(override val repr: Array[Int]) extends AnyVal with ArrayOps[L, Int] with ArrayLike[L, Int, Array[Int]] {

    override protected[this] def thisCollection: WrappedArray[L, Int] = new WrappedArray.ofInt(repr)
    override protected[this] def toCollection(repr: Array[Int]): WrappedArray[L, Int] = new WrappedArray.ofInt(repr)
...
final class ofLong(override val repr: Array[Long]) extends AnyVal with ArrayOps[L, Long] with ArrayLike[L, Long, Array[Long]] {

    override protected[this] def thisCollection: WrappedArray[L, Long] = new WrappedArray.ofLong(repr)
    override protected[this] def toCollection(repr: Array[Long]): WrappedArray[L, Long] = new WrappedArray.ofLong(repr)
...
final class ofFloat(override val repr: Array[Float]) extends AnyVal with ArrayOps[L, Float] with ArrayLike[L, Float, Array[Float]] {

    override protected[this] def thisCollection: WrappedArray[L, Float] = new WrappedArray.ofFloat(repr)
    override protected[this] def toCollection(repr: Array[Float]): WrappedArray[L, Float] = new WrappedArray.ofFloat(repr)
...
final class ofDouble(override val repr: Array[Double]) extends AnyVal with ArrayOps[L, Double] with ArrayLike[L, Double, Array[Double]] {

    override protected[this] def thisCollection: WrappedArray[L, Double] = new WrappedArray.ofDouble(repr)
    override protected[this] def toCollection(repr: Array[Double]): WrappedArray[L, Double] = new WrappedArray.ofDouble(repr)
...
final class ofBoolean(override val repr: Array[Boolean]) extends AnyVal with ArrayOps[L, Boolean] with ArrayLike[L, Boolean, Array[Boolean]] {

    override protected[this] def thisCollection: WrappedArray[L, Boolean] = new WrappedArray.ofBoolean(repr)
    override protected[this] def toCollection(repr: Array[Boolean]): WrappedArray[L, Boolean] = new WrappedArray.ofBoolean(repr)
...
final class ofUnit(override val repr: Array[Unit]) extends AnyVal with ArrayOps[L, Unit] with ArrayLike[L, Unit, Array[Unit]] {

    override protected[this] def thisCollection: WrappedArray[L, Unit] = new WrappedArray.ofUnit(repr)
    override protected[this] def toCollection(repr: Array[Unit]): WrappedArray[L, Unit] = new WrappedArray.ofUnit(repr)
